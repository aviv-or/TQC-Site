...
!function (e) {
  "use strict";
  var a = e(window), i = e("body"), t = e(".navbar");
  ...
  e('a.menu-link[href*="#"]:not([href="#"])').on("click", function () {
    if (location.pathname.replace(/^\//, "") === this.pathname.replace(/^\//, "") && location.hostname === this.hostname) {
      ...
      if ((a = a.length ? a : i).length) return e("html, body").animate({ scrollTop: a.offset().top - l }, 1e3, "easeInOutExpo"), !1
    }
  });
  var o = window.location.href, d = o.split("#"), c = e(".nav li a");
  ...
  var h = e(".navbar-toggler"), u = e(".is-transparent");
  ...
  v.length > 0 && v.each(function () {
    var a = e(this), i = a.attr("data-date");
  ...
  var C = e(".imagebg");
  C.length > 0 && C.each(function () {
    var a = e(this), i = a.parent(), t = a.data("overlay"), l = a.children("img").attr("src"),
  ...
  var y = e("#contact-form"), k = e("#subscribe-form");
  if (y.length > 0 || k.length > 0) {
    ...
    if (y.length > 0) {
      var z = y.find("select.required"), j = y.find(".form-results");
      y.validate({
        invalidHandler: function () {
          j.slideUp(400)
        }, submitHandler: function (a) {
          j.slideUp(400), e(a).ajaxSubmit({
            target: j, dataType: "json", success: function (i) {
      ...
      k.validate({
        invalidHandler: function () {
          ...
          D.slideUp(400), e(a).ajaxSubmit({
            target: D, dataType: "json", success: function (i) {
              var t = "error" === i.result ? "alert-danger" : "alert-success";
  ...
  var T = "images/", B = "RTL Mode", L = "./rtl/index.html";
  i.hasClass("is-rtl") && (T = "../images/", B = "LTR Mode", L = "../index.html");
